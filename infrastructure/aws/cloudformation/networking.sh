stack_create=$(aws cloudformation create-stack --template-body file://csye6225-cf-networking.yaml --stack-name summercloud2019-vpc --capabilities CAPABILITY_NAMED_IAM profile dev --parameters ParameterKey=Zone1,ParameterValue=us-east-1a ParameterKey=Zone2,ParameterValue=us-east-1c ParameterKey=Zone3,ParameterValue=us-east-1d) 
