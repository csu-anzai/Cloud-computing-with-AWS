...
stack_create=$(aws cloudformation create-stack --template-body file://csye6225-cf-application.yaml --capabilities CAPABILITY_IAM  --stack-name $4 --parameters ParameterKey=AMI,ParameterValue=$1 ParameterKey=VPC,ParameterValue=$2 ParameterKey=AWSKEY,ParameterValue=$3 ParameterKey=Subnet1,ParameterValue=$5 ParameterKey=Subnet2,ParameterValue=$6)
